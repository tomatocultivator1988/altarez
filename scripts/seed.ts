...
async function main() {
  ...
  console.log("\n─ Inserting machinery...")
  const machinery = [
    { owner_id: juanId, machine_name: "John Deere 6120M", machine_type: "4wd_tractor", description: "120 HP 4WD tractor with rotavator and trailer. Ideal for large-scale land preparation.", serial_number: "JD-6120M-2024-001", hectares_capacity: 5, rate_per_hectare: 1500, barangay: "Brgy. Alimodian", image_url: null, status: "active" },
    { owner_id: juanId, machine_name: "Kubota M7060", machine_type: "hand_tractor", description: "70 HP hand tractor with disc plow and harrow. Perfect for small to medium farms.", serial_number: "KT-M7060-2024-002", hectares_capacity: 2, rate_per_hectare: 500, barangay: "Brgy. Alimodian", image_url: null, status: "active" },
    { owner_id: juanId, machine_name: "Yanmar Combine Harvester", machine_type: "harvester", description: "4-row combine harvester with GPS guidance. Cuts and threshes in one pass.", serial_number: "YR-4R-2024-003", hectares_capacity: 8, rate_per_hectare: 2500, barangay: "Brgy. Igtambo", image_url: null, status: "active" },
    { owner_id: juanId, machine_name: "GrainPro Dryer 10T", machine_type: "dryer", description: "10-ton capacity recirculating grain dryer. Maintains grain quality with even drying.", serial_number: "GP-10T-2024-004", hectares_capacity: 10, rate_per_hectare: 800, barangay: "Brgy. Igtambo", image_url: null, status: "active" },
    { owner_id: mariaId, machine_name: "Power Tiller FT-300", machine_type: "floating_tiller", description: "Floating power tiller for wetland rice paddies. Excellent flotation in muddy fields.", serial_number: "PT-FT300-2024-005", hectares_capacity: 1.5, rate_per_hectare: 400, barangay: "Brgy. Carabalan", image_url: null, status: "active" },
    { owner_id: mariaId, machine_name: "Isuzu Farm Truck 4x4", machine_type: "hauling", description: "4x4 farm truck with hydraulic lift bed. Hauls palay, fertilizers, and equipment.", serial_number: "IS-4x4-2024-006", hectares_capacity: 0, rate_per_hectare: 1200, barangay: "Brgy. Carabalan", image_url: null, status: "active" },
    { owner_id: mariaId, machine_name: "Satake Rice Miller S-10", machine_type: "miller", description: "Satake single-pass rice mill. Produces premium milled rice with minimal breakage.", serial_number: "ST-S10-2024-007", hectares_capacity: 3, rate_per_hectare: 600, barangay: "Brgy. Lantangan", image_url: null, status: "active" },
    { owner_id: mariaId, machine_name: "Multi-Purpose Craft Shop", machine_type: "craft_establishment", description: "Fully equipped crafts and repair shop for agricultural implements and machinery.", serial_number: "MPC-001-2024-008", hectares_capacity: 0, rate_per_hectare: 0, barangay: "Brgy. Lantangan", image_url: null, status: "maintenance" },
  ]
  ...
  console.log("\n─ Inserting bookings...")
  const bookings = [
    { machinery_id: jdTractor.id, renter_id: pedroId, owner_id: juanId, status: "pending", requested_hectares: 3, starting_date: addDays(NOW, 1), ending_date: addDays(NOW, 3), estimated_hours: 12, total_amount: 18000, security_deposit: 5400, payment_status: "unpaid", notes: "Need for land preparation before rainy season. Prefer morning schedule." },
    { machinery_id: kubota.id, renter_id: pedroId, owner_id: juanId, status: "approved", requested_hectares: 1.5, starting_date: addDays(NOW, 7), ending_date: addDays(NOW, 9), estimated_hours: 8, total_amount: 4000, security_deposit: 1200, payment_status: "unpaid", notes: "For secondary tillage on my 2-hectare lot." },
    { machinery_id: tiller.id, renter_id: anaId, owner_id: mariaId, status: "active", requested_hectares: 1, starting_date: addDays(NOW, -2), ending_date: addDays(NOW, 1), estimated_hours: 6, total_amount: 2400, security_deposit: 720, hour_meter_start: 45, pickup_documented_at: new Date(NOW.getTime() - 2 * 86400000).toISOString(), pickup_documented_by: mariaId, payment_status: "unpaid", notes: "Emergency tillage — need to catch up with planting schedule." },
    { machinery_id: combine.id, renter_id: anaId, owner_id: juanId, status: "completed", requested_hectares: 4, starting_date: addDays(NOW, -7), ending_date: addDays(NOW, -5), estimated_hours: 10, total_amount: 25000, security_deposit: 7500, hour_meter_start: 100, hour_meter_end: 110, actual_hours: 10, actual_hectares: 80, pickup_documented_at: new Date(NOW.getTime() - 7 * 86400000).toISOString(), pickup_documented_by: juanId, return_documented_at: new Date(NOW.getTime() - 5 * 86400000).toISOString(), return_documented_by: juanId, payment_status: "paid", notes: "Harvest completed. Yield was good — around 120 cavans." },
    { machinery_id: truck.id, renter_id: carlosId, owner_id: mariaId, status: "completed", requested_hectares: 0, starting_date: addDays(NOW, -14), ending_date: addDays(NOW, -12), estimated_hours: 5, total_amount: 6000, security_deposit: 1800, hour_meter_start: 230, hour_meter_end: 235, actual_hours: 5, pickup_documented_at: new Date(NOW.getTime() - 14 * 86400000).toISOString(), pickup_documented_by: mariaId, return_documented_at: new Date(NOW.getTime() - 12 * 86400000).toISOString(), return_documented_by: mariaId, payment_status: "paid", notes: "Hauled 200 sacks of palay to the mill. Driver was very professional." },
    { machinery_id: miller.id, renter_id: pedroId, owner_id: mariaId, status: "denied", requested_hectares: 2, starting_date: addDays(NOW, -30), ending_date: addDays(NOW, -28), estimated_hours: 4, total_amount: 2400, security_deposit: 720, payment_status: "unpaid", notes: "Requested for milling but machine was under maintenance at the time." },
    { machinery_id: dryer.id, renter_id: carlosId, owner_id: juanId, status: "cancelled", requested_hectares: 5, starting_date: addDays(NOW, -35), ending_date: addDays(NOW, -33), estimated_hours: 8, total_amount: 6400, security_deposit: 1920, payment_status: "unpaid", notes: "Cancelled due to weather — dried palay naturally instead." },
  ]
